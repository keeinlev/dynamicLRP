...
\begin{itemize}
  ...
  modules to enable model agnosticity. Complete with rules for 47 fundamental tensor operations already implemented (See Table~\ref{supported-operations-table}).
...
\begin{table}[!h]
\begin{center}
  \label{supported-operations-table}
  \begin{tabular}{ll}
    \toprule
