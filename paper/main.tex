...
\title{Always keep your promises: A model-agnostic solution to Layer-wise Relevance Propagation}
...
but suffer from gradient saturation and linearity assumptions that fail to capture complex nonlinear interactions
\cite{ancona2018towards}. Perturbation-based approaches like SHAP \cite{lundberg2017unified} and LIME
...
Rule-based decomposition methods, pioneered by Layer-wise Relevance Propagation (LRP) \cite{bach2015pixel}, offer a
compelling alternative through systematic relevance redistribution. Unlike gradients, which reflect local sensitivity,
...
Through our novel \textbf{"Promise System"} for handling missing forward activations, our approach repurposes the computation
graph used in auto-differentiation, and maintains LRP's theoretical guarantees while achieving computational efficiency
within the asymptotic bounds of standard backpropagation.
