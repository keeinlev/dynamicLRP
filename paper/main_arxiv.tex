...
\begin{itemize}
  ...
  modules to enable model agnosticity. Complete with rules for 47 fundamental tensor operations already implemented (See Appendix~\ref{sec:covered-operations}).
