...
rules and model modifications. These limit the generality of target model and sustainability of implementations as architectures evolve.
...
backpropagation machinery, requiring no model modification, enabling side-by-side execution with gradient backpropagation. Being based on
computation graphs, this method is theoretically extensible to other deep learning libraries that support auto-differentiation.
...
maintaining practical efficiency on models with 100M-1B parameters.
...
All code is available at \url{https://github.com/keeinlev/dynamicLRP}.
\end{abstract}
